...
gem 'validates_zipcode', '~> 0.0.8'       # Zipcode validation
...
gem 'authority', '~> 3.1'                 # Use Authority for authZ

# See https://github.com/intridea/omniauth/wiki/List-of-Strategies for strategies
gem 'omniauth-facebook', '~> 3.0'         # Use OmniAuth for Facebook, see https://github.com/mkdynamic/omniauth-facebook
...
group :development, :test do
  ...
  gem 'factory_girl_rails', '~> 4.6'      # Use FactoryGirl for seeds and what not
