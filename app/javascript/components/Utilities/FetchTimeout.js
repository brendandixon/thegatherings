/**
 * See https://github.com/jkomyno/fetch-timeout
 * 
 * - Pulled code directly since the NPM package has unwanted dependencies
 */
...
module.exports = function fetchTimeout(url, options, timeout, error) {
    ...
    error = error || `Fetch ${url} timed out after ${timeout} milliseconds`;
